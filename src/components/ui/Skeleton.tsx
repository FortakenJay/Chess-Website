...
export function BoardPageSkeleton({
  ...
  return (
    <div
      className={cn(
        'grid min-h-0 gap-4 lg:h-full lg:min-h-0 lg:flex-1 lg:grid-cols-[minmax(0,1fr)_minmax(14rem,18rem)]',
        className,
      )}
      aria-busy="true"
      aria-label={label}
    >
      <div className="flex min-h-0 min-w-0 flex-col border border-line bg-surface">
        ...
        <div className="relative aspect-square w-full lg:aspect-auto lg:min-h-0 lg:flex-1 p-2 [container-type:size]">
